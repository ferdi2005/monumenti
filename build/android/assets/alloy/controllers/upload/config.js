...
var alert=Ti.UI.createAlertDialog({message:"Si \xE8 verificato un errore. Riprova pi\xF9 tardi. ",buttonNames:["Ok"]});
alert.addEventListener("click",function(e){
$.config.close();
}),
alert.show();
...
$.mediawiki_data.text=!0==userInfo.testuser?"Hai eseguito l'accesso alla Wiki di test. Le tue foto non verranno caricate davvero.":

"Hai eseguito l'accesso a Wikimedia Commons.",
...
function retrieveUserData(uuid,token){var
...
if(!0==e.success)
retrieveUserData(uuid,e.value);else
{
